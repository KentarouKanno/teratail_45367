...
class DataModel {
    ...
    class func createData() -> [[DataModel]] {
        let dataArray1 = [DataModel("A"), DataModel("B"), DataModel("C", isShowButton: true, isOpenCell: true), DataModel(), DataModel("D")]
        let dataArray2 = [DataModel("1"), DataModel("2", isShowButton: true), DataModel("3")]
        let dataArray3 = [DataModel("a", isShowButton: true), DataModel("b"), DataModel("c"), DataModel("d")]
